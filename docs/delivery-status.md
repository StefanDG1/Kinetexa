...
After the latest tag, archive recovery and stale-worker corrections pass 114 focused tests and a hosted isolated partial-archive journey. The clean restore verified 45 objects, seven activity streams, thirteen health records and deletion exclusion across 25 tables. The corrections are deployed to staging and the closed production backend. These checks do not close the remaining connector, operational or product acceptance gates.
